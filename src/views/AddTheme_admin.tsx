...
const AddThemePage: React.FC = () => {
    ...
    const handleAddTheme = () => {
        ...
        console.log({ themeName, duration, budget, deadline });
    };
    ...
    return (
        <div className="flex h-screen">
            ...
            <div className="flex-1 flex flex-col items-center justify-center p-8 bg-gray-50">
                <div className="w-full max-w-3xl flex space-x-8">
                    ...
                    <div className="flex-1 space-y-6">
                        <h1 className="text-2xl text-[#033469] font-bold mb-6">Add Themes</h1>
            ...
            <div className="mt-6 flex space-x-4">
                <Button onClick={handleAddTheme} className="bg-[#033469] text-white">
                    Add Theme
                </Button>
                <Button 
