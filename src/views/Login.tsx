      ...
      <div className="min-h-screen flex items-center justify-center bg-background px-40">
        <div className="bg-[#CEE0F3] p-20 rounded-md shadow-md w-full max-w-lg">
          ...
          <form onSubmit={handleSubmit}>
            <TextInput  required label='Username or Email' placeholder="Enter your username or email"
             value={email} onChange={(e)=>{ setEmail(e.target.value)}}/>
                
            <TextInput required label='Password' type={hidePassword? "text" :"password"} placeholder="Enter your password"
